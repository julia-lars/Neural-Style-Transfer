...
style_path   = "data/style-images/s4.png"
...
#gen_img = nn.Parameter(torch.randn(content_raw.shape).to(device)) #初始化生成图像
...
with torch.no_grad():
    ...
    img_pil.save("gatys_improved_stage1.png")
...
final_img.save("gatys_improved_stage2.png")
